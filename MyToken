...
contract MyToken {
    ...
    mapping(address => uint) public balances; // made public for ease during demo 
    // passing an address here will return the token amount, since every address is associated with a uint
